  ...
  return (
    <div className="container mx-auto my-3">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-10 my-10">
        <div className="cursor-pointer rounded-lg bg-right bg-women flex flex-col justify-center items-start px-10 min-h-[250px] object-right bg-riht lg:bg-center bg-cover bg-no-repeat relative">
